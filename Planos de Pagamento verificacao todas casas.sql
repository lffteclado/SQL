...
select CodigoPlanoPagamento as Cardiesel, DescricaoPlanoPagamento, BloqueadoPlanoPagto, PlanoEspecial from dbCardiesel.dbo.tbPlanoPagamento where PlanoEspecial = 'F' and BloqueadoPlanoPagto = 'F' and EntradaSaidaPlanoPagamento = 'S'
...
select CodigoPlanoPagamento as Valadares, DescricaoPlanoPagamento, BloqueadoPlanoPagto, PlanoEspecial from dbValadares.dbo.tbPlanoPagamento where PlanoEspecial = 'F' and BloqueadoPlanoPagto = 'F' and EntradaSaidaPlanoPagamento = 'S'
