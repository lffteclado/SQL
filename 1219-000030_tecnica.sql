...
where versaoCodigo.fk_tabela_tiss not in(
	select tiss.id from tb_tabela_tiss_versao_codigo versaoCodigo
		inner join tb_tabela_tiss tiss on (tiss.id = versaoCodigo.fk_tabela_tiss and tiss.registro_ativo = 1 and versaoCodigo.registro_ativo = 1)
	where tiss.fk_relacao_tuss = 30 and versaoCodigo.versao_tiss = 6
) and tiss.fk_relacao_tuss = 30
) 
...
where versaoCodigo.fk_tabela_tiss not in(
	select tiss.id from tb_tabela_tiss_versao_codigo versaoCodigo
		inner join tb_tabela_tiss tiss on (tiss.id = versaoCodigo.fk_tabela_tiss and tiss.registro_ativo = 1 and versaoCodigo.registro_ativo = 1)
	where tiss.fk_relacao_tuss = 30 and versaoCodigo.versao_tiss = 7
) and tiss.fk_relacao_tuss = 30
) 
...
where versaoCodigo.fk_tabela_tiss not in(
	select tiss.id from tb_tabela_tiss_versao_codigo versaoCodigo
		inner join tb_tabela_tiss tiss on (tiss.id = versaoCodigo.fk_tabela_tiss and tiss.registro_ativo = 1 and versaoCodigo.registro_ativo = 1)
	where tiss.fk_relacao_tuss = 30 and versaoCodigo.versao_tiss = 8
) and tiss.fk_relacao_tuss = 30
) 
...
where versaoCodigo.fk_tabela_tiss not in(
	select tiss.id from tb_tabela_tiss_versao_codigo versaoCodigo
		inner join tb_tabela_tiss tiss on (tiss.id = versaoCodigo.fk_tabela_tiss and tiss.registro_ativo = 1 and versaoCodigo.registro_ativo = 1)
	where tiss.fk_relacao_tuss = 30 and versaoCodigo.versao_tiss = 9
) and tiss.fk_relacao_tuss = 30
) 
...
where versaoCodigo.fk_tabela_tiss not in(
	select tiss.id from tb_tabela_tiss_versao_codigo versaoCodigo
		inner join tb_tabela_tiss tiss on (tiss.id = versaoCodigo.fk_tabela_tiss and tiss.registro_ativo = 1 and versaoCodigo.registro_ativo = 1)
	where tiss.fk_relacao_tuss = 30 and versaoCodigo.versao_tiss = 10
) and tiss.fk_relacao_tuss = 30
) 
...
where versaoCodigo.fk_tabela_tiss not in(
	select tiss.id from tb_tabela_tiss_versao_codigo versaoCodigo
		inner join tb_tabela_tiss tiss on (tiss.id = versaoCodigo.fk_tabela_tiss and tiss.registro_ativo = 1 and versaoCodigo.registro_ativo = 1)
	where tiss.fk_relacao_tuss = 30 and versaoCodigo.versao_tiss = 11
) and tiss.fk_relacao_tuss = 30
)
...
where versaoCodigo.fk_tabela_tiss not in(
	select tiss.id from tb_tabela_tiss_versao_codigo versaoCodigo
		inner join tb_tabela_tiss tiss on (tiss.id = versaoCodigo.fk_tabela_tiss and tiss.registro_ativo = 1 and versaoCodigo.registro_ativo = 1)
	where tiss.fk_relacao_tuss = 30 and versaoCodigo.versao_tiss = 12
) and tiss.fk_relacao_tuss = 30
) 
