        ...
        (select calculado.data_ultima_alteracao as data_ultima_alteracao, 
				...
				dadosBancarios.nao_enviar_cooperado_cnab,
				dadosBancarios.codigo_lancamento,
				dadosBancarios.numero_convenio
     ...
     inner join rl_entidade_cooperado_dados_bancarios dadosBancarios on (dadosBancarios.fk_entidade_cooperado = entidadeCooperado.id and dadosBancarios.situacao = 1 and dadosBancarios.registro_ativo = 1) 
          where calculado.fk_repasse = 18018
