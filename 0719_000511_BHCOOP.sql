...
select id from rl_entidade_cooperado where fk_entidade=17 ) and registro_ativo=1
...
cross apply ( 
             ...
             where endereco.fk_entidade=17 and discriminator='Cooperado'
             and entidadeCooperadoAcima.fk_entidade=17 
             ...
             where entidadeCooperado.fk_entidade=17 
...
where entidadeCooperadoAcima.fk_entidade=17 and entidadeCooperadoAcima.registro_ativo=1
and not exists(select correspondencia.id from tb_correspondencia_endereco correspondencia
