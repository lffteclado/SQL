...
select  cooperado.numero_conselho as 'CRM'
		...
		,(declaracao.valor_inss - declaracao.valor_devolucao) as 'Valor Retido'
...
where importacao.id = 137030) as integracao
...
and (declaracao.valor_inss - declaracao.valor_devolucao) > 0
