...
where procedimento.data_realizacao < '2019-04-01' -- Anterior a 01/04/2019
...
--and situacao.repassado = 1
and (situacao.glosado = 1 or situacao.digitado = 1 or situacao.espelhado = 1 or situacao.faturado = 1 /*or situacao.repassado = 1*/)
and (glosa.situacao <> 2 and glosa.situacao <> 4)
--and atendimento.numero_atendimento_automatico = 2853470
