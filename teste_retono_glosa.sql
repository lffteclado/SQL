...
--select * from tb_carta_glosa where id = 256663
...
where situacao.valorGlosado <> 0.00 and glosa.registro_ativo = 1 order by id_procedimento

--and glosa.valor_recebido = 0.00
