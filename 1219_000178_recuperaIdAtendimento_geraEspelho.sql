select distinct atendimento.id
...
and entidadeAcomodacao.fk_entidade = 6
...
and atendimento.fk_convenio = 5796
group by atendimento.id
         ,atendimento.ano_atendimento
		 ,atendimento.numero_atendimento_automatico
		  --,atendimento.paciente
		  --,procedimento.data_realizacao
--ORDER BY atendimento.paciente ASC
ORDER BY atendimento.ano_atendimento ASC, atendimento.numero_atendimento_automatico ASC
--ORDER BY procedimento.data_realizacao ASC