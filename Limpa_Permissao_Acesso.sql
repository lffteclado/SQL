...
select * from  tbPermissaoAcesso where CodigoUsuario = 'LFORTES' and CodigoFormulario like '%frmce%'
...
--DELETE tbPermissaoAcesso where CodigoUsuario = 'LFORTES' and CodigoFormulario = 'frmceEntradas'
