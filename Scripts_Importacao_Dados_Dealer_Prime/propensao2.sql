...
INNER JOIN tbResultadoVisitaST AS rv on tp.CodigoClienteST = rv.CodigoClienteST WHERE l.CodigoLocal = 0 and f.CPFFisica NOT LIKE 'ISENTO' AND f.CPFFisica IS NOT NULL Group By l.CGCLocal,tp.Categoria,tp.PropensaoCompra, f.CPFFisica
