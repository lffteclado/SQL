...
WHERE l.CodigoLocal = 0 AND j.CGCJuridica NOT LIKE 'ISENTO' and j.CGCJuridica = '00952948000147'
FOR XML PATH('itemFrota'),
ROOT('frotas')

	--WHERE f.CPFFisica NOT LIKE 'ISENTO' AND f.CPFFisica IS NOT NULL

select * from tbFrotaCliente where NumeroClientePotencialEfetivo = '00952948000147'

select * from tbCliFor where CodigoCliFor = '00952948000147'