SELECT distinct RTRIM(LTRIM(l.CGCLocal)) AS concessao,
	CASE
	 ...
	 --  CASE
	   ...
	   '('+ Substring(c.DDDTelefoneCliFor,1,2) + ')' 
       + Substring(c.DDDCelularCliFor,1,4)+ '-'
...
INNER JOIN tbCliForJuridica as j on c.CodigoCliFor = j.CodigoCliFor WHERE j.CGCJuridica NOT LIKE 'ISENTO' OR j.CGCJuridica NOT LIKE '111111111111' OR j.CGCJuridica <> NULL
