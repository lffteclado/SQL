go
if exists(select 1 from sysobjects where id = object_id('whPClienteMonitoramento1')) begin
DROP PROCEDURE dbo.whPClienteMonitoramento1 end

GO
CREATE PROCEDURE dbo.whPClienteMonitoramento1
/*INICIO_CABEC_PROC
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
whPClienteMonitoramento 1608, 0, '2009-03-01', '2009-03-30', 'CV'
whPClienteMonitoramento 1608, 0, '2009-03-01', '2009-03-30', 'CV', 12

whPClienteMonitoramento 1608, 0, '2009-07-01', '2009-07-30', 'OS'
whPClienteMonitoramento 1608, 0, '2009-03-01', '2009-03-30', 'OS', 55
...
--	and cit.GarantiaCIT = 'F' 
	...
	and mon.IdMonitoramento = @IdMonitoramento
...
GO
GRANT EXECUTE ON dbo.whPClienteMonitoramento1 TO SQLUsers
GO
