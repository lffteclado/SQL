...
insert tbRazaoProdutos
 select a.CodigoEmpresa,
  a.CodigoLocal,
  a.CodigoProduto,
  sum(QtdeAnteriorSaldoAlmoxarifado),
  0, -- ValSaldoAnterior
  0, -- QtdeCompras
  0, -- ValorCompras
  0, -- QtdeDevVendas
  ...
  sum(QtdeAnteriorSaldoAlmoxarifado + QtdeEntradaSaldoAlmoxarifado - QtdeSaidaSaldoAlmoxarifado),
  a.SaldoValorEstoque,
  0, -- QtdeSaldoApurado
  0  -- ValorSaldoApurado
 from tbValorEstoquePeriodo a
 inner join tbSaldoAlmoxarifadoPeriodo b
...
and a.CodigoAlmoxDestinoItemDocto not in (select CodigoAlmoxarifado from tbAlmoxarifado
							where	CodigoEmpresa	= a.CodigoEmpresa
							and	CodigoLocal	= a.CodigoLocal
							and	TipoAlmoxarifadoConsumo IN ('C', 'D')
						)
...
and a.CodigoAlmoxOrigemItemDocto not in (select CodigoAlmoxarifado from tbAlmoxarifado
							where	CodigoEmpresa	= a.CodigoEmpresa
							and	CodigoLocal	= a.CodigoLocal
							and	TipoAlmoxarifadoConsumo IN ('C', 'D')
						)
