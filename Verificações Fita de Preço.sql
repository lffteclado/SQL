...
-- drop table tbTabelaPreco11062018  ( Avaliar se necessário _)
-- drop table tempItemForaTabela ( Avaliar se necessário _)
-- select * into tbTabelaPreco13062018 from tbTabelaPreco
...
-- select sum(ValorTabelaPreco) from tbTabelaPreco as tbP where exists (select CodPro from tempItemForaTabela as tbIP where tbP.CodigoProduto = tbIP.CodPro and tbIP.CodAlt = 'A' and tbP.ValorTabelaPreco = tbIP.CodPreco ) and DataValidadeTabelaPreco = '2018-06-11'